...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    Note note1 = Note("C5", 0.08, 1);
    Note note2 = Note ("G5", 0.08, 1);
    Note note3 = Note ("C6", 0.08, 1);
    Sequence sequence1 = Sequence({note1, note2, note3});
    Note note4 = Note ("D5", 0.08, 1);
    Note note5 = Note ("A5", 0.08, 1);
    Note note6 = Note ("D6", 0.08, 1);
    Sequence sequence2 = Sequence({note4, note5, note6});
    Note note7 = Note ("E5", 0.08, 1);
    Note note8 = Note ("B5", 0.08, 1);
    Note note9 = Note ("E6", 0.08, 1);
    Sequence sequence3 = Sequence({note7, note8, note9});
    Note note10 = Note ("F5", 0.08, 1);
    Note note11 = Note ("C6", 0.08, 1);
    Note note12 = Note ("F6", 0.08, 1);
    Sequence sequence4 = Sequence({note10, note11, note12});
    Note note13 = Note ("G5", 0.08, 1);
    Note note14 = Note ("D6", 0.08, 1);
    Note note15 = Note ("G6", 0.08, 1);
