...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    //create some synths
    Note note1 = Note("C3", 0.2, 1);
    Note note2 = Note("E3", 0.2, 1);
    Note note3 = Note("G3", 0.2, 1);
    Sequence sequence1 = Sequence({note1, note2, note3});
    Note note4 = Note("E4", 0.2, 1);
    Note note5 = Note("G4", 0.2, 1);
    Note note6 = Note("B4", 0.2, 1);
    Sequence sequence2 = Sequence({note4, note5, note6});
    Note note7 = Note("G5", 0.2, 1);
    Note note8 = Note("B5", 0.2, 1);
    Note note9 = Note("D6", 0.2, 1);
    Sequence sequence3 = Sequence({note7, note8, note9});
    Note note10 = Note("B6", 0.2, 1);
    Note note11 = Note("D7", 0.2, 1);
    Note note12 = Note("F7", 0.2, 1);
    Sequence sequence4 = Sequence({note10, note11, note12});
    Note note13 = Note("D8", 0.2, 1);
    Note note14 = Note("F8", 0.2, 1);
    Note note15 = Note("A8", 0.2, 1);
