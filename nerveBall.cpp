...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    Note note1 = Note("C4", 0.03, 1);
    Note note2 = Note ("E4", 0.03, 1);
    Note note3 = Note ("G4", 0.03, 1);
    Sequence sequence1 = Sequence({note1, note2, note3});
    Note note4 = Note ("D4", 0.03, 1);
    Note note5 = Note ("F4", 0.03, 1);
    Note note6 = Note ("A4", 0.03, 1);
    Sequence sequence2 = Sequence({note4, note5, note6});
    Note note7 = Note ("E4", 0.03, 1);
    Note note8 = Note ("G4", 0.03, 1);
    Note note9 = Note ("B4", 0.03, 1);
    Sequence sequence3 = Sequence({note7, note8, note9});
    Note note10 = Note ("F4", 0.03, 1);
    Note note11 = Note ("A4", 0.03, 1);
    Note note12 = Note ("C5", 0.03, 1);
    Sequence sequence4 = Sequence({note10, note11, note12});
    Note note13 = Note ("G4", 0.03, 1);
    Note note14 = Note ("B4", 0.03, 1);
    Note note15 = Note ("D5", 0.03, 1);
