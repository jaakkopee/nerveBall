...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    Sequence sequence1 = Sequence({note1, note1_, note2, note2_, note3, note3_});
    ...
    Sequence sequence2 = Sequence({note4, note4_, note5, note5_, note6, note6_});
    ...
    Sequence sequence3 = Sequence({note7, note7_, note8, note8_, note9, note9_});
    ...
    Sequence sequence4 = Sequence({note10, note10_, note11, note11_, note12, note12_});
    ...
    Sequence sequence5 = Sequence({note13, note13_, note14, note14_, note15, note15_});
