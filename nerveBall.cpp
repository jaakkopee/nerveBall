...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    Note note4 = Note ("C5", 0.03, 1);
    Note note5 = Note ("E5", 0.03, 1);
    Note note6 = Note ("G5", 0.03, 1);
    Sequence sequence2 = Sequence({note4, note5, note6});
    Note note7 = Note ("C6", 0.03, 1);
    Note note8 = Note ("E6", 0.03, 1);
    Note note9 = Note ("G6", 0.03, 1);
    Sequence sequence3 = Sequence({note7, note8, note9});
    Note note10 = Note ("C7", 0.03, 1);
