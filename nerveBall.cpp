...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    //create some synths
    Note note1 = Note("C3", 0.05, 1);
    Note note1_ = Note("C4", 0.05, 1);
    Note note1__ = Note("F#3", 0.05, 1);
    Note note2 = Note("E3", 0.05, 1);
    Note note2_ = Note("E4", 0.05, 1);
    Note note2__ = Note("A3", 0.05, 1);
    Note note3 = Note("G3", 0.05, 1);
    Note note3_ = Note("G4", 0.05, 1);
    Note note3__ = Note("C4", 0.05, 1);
    ...
    Note note4 = Note("E4", 0.05, 1);
    Note note4_ = Note("E5", 0.05, 1);
    Note note4__ = Note("A4", 0.05, 1);
    Note note5 = Note("G4", 0.05, 1);
    Note note5_ = Note("G5", 0.05, 1);
    Note note5__ = Note("C5", 0.05, 1);
    Note note6 = Note("B4", 0.05, 1);
    Note note6_ = Note("B5", 0.05, 1);
    Note note6__ = Note("E5", 0.05, 1);
    ...
    Note note7 = Note("G4", 0.05, 1);
    Note note7_ = Note("G5", 0.05, 1);
    Note note7__ = Note("C5", 0.05, 1);
    Note note8 = Note("B4", 0.05, 1);
    Note note8_ = Note("B5", 0.05, 1);
    Note note8__ = Note("E5", 0.05, 1);
    Note note9 = Note("D5", 0.05, 1);
    Note note9_ = Note("D6", 0.05, 1);
    Note note9__ = Note("G5", 0.05, 1);
    ...
    Note note10 = Note("B4", 0.05, 1);
    Note note10_ = Note("B5", 0.05, 1);
    Note note10__ = Note("E5", 0.05, 1);
    Note note11 = Note("D5", 0.05, 1);
    Note note11_ = Note("D6", 0.05, 1);
    Note note11__ = Note("G5", 0.05, 1);
    Note note12 = Note("F5", 0.05, 1);
    Note note12_ = Note("F6", 0.05, 1);
    Note note12__ = Note("A5", 0.05, 1);
    ...
    Note note13 = Note("D5", 0.05, 1);
    Note note13_ = Note("D6", 0.05, 1);
    Note note13__ = Note("G5", 0.05, 1);
    Note note14 = Note("F5", 0.05, 1);
    Note note14_ = Note("F6", 0.05, 1);
    Note note14__ = Note("A5", 0.05, 1);
    Note note15 = Note("A5", 0.05, 1);
    Note note15_ = Note("A6", 0.05, 1);
    Note note15__ = Note("D6", 0.05, 1);
