...
nerveBall::BallNetwork::BallNetwork()
{
    ...
    Note note7 = Note("G5", 0.06, 1);
    Note note8 = Note("B5", 0.06, 1);
    Note note9 = Note("D6", 0.06, 1);
    Sequence sequence3 = Sequence({note7, note8, note9});
    Note note10 = Note("B6", 0.06, 1);
    Note note11 = Note("D7", 0.06, 1);
    Note note12 = Note("F7", 0.06, 1);
    Sequence sequence4 = Sequence({note10, note11, note12});
    Note note13 = Note("D8", 0.06, 1);
    Note note14 = Note("F8", 0.06, 1);
    Note note15 = Note("A8", 0.06, 1);
